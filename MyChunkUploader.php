 ...
 * 
 * @id      : MyChunkUploader.php | Thu Feb 11 09:31:19 2016 +0100 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
class MyChunkUploader {
	...
	private function _get_header_value( $header_name ) {
		file_put_contents(__FILE__.'get_hdr', 'searching for '.$header_name.' within '.print_r($this->_headers,1).PHP_EOL,8);
